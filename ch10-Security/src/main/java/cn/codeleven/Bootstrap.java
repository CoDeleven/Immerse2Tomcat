...
import cn.codeleven.core.SimpleContextMapper;
import cn.codeleven.core.SimpleContextValve;
import cn.codeleven.core.SimpleWrapper;
import cn.codeleven.core.SimpleWrapperValve;
import cn.codeleven.realm.SimpleConfigRealm;
...
//        context.addValve(new SimpleIPLogValve(context));
    ...
    private static void setSecurityConstraint(Context context){
        ...
        Realm realm = new SimpleConfigRealm("config/tomcat-users.xml");
